...
echo.
echo ============================================================
echo [JARVIS CONFIGURATION] OPENROUTER API KEY
echo ============================================================
...
echo.
echo ============================================================
echo [JARVIS CONFIGURATION] GEMINI API KEY
echo ============================================================
...
:: Ensure at least one key was provided
if not defined OR_USER_KEY if not defined GEM_USER_KEY (
    echo.
    echo ============================================================
    echo [ERROR] You skipped both API keys! At least one key is required.
    echo Please enter an OpenRouter key, a Gemini key, or both.
    echo ============================================================
    echo.
    pause
    goto API_KEY_LOOP
