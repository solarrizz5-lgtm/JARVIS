  ...
  def start_animations(self):
    def animate():
      ...
      self.canvas.create_arc(
          ...
          cx + 55,
          cy + 55,
          start=(self.rotation_angle + 180) % 360,
          extent=110,
          outline="#00f0ff",
          width=2,
          style="arc",
      ...
      # Center Microphone Visualizer Icon
      mic_w, mic_h = 16, 28
      self.canvas.create_oval(
          cx - mic_w,
          cy - mic_h,
      ...
      self.canvas.create_line(
          cx, cy + 22, cx, cy + 30, fill="#ffffff", width=2
      )
      self.canvas.create_line(
          cx - 12, cy + 30, cx + 12, cy + 30, fill=accent_color, width=2
      )
